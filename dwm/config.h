...
static const Rule rules[] = {
	...
	{ "librewolf",  NULL,       NULL,       1 << 6,       0,             0,           -1 },
	{ "krita",		NULL,       NULL,       1 << 9,       0,             0,           -1 },
};
...
static const char *kill_dwm[] = {"pkill", "dwm", NULL};
...
static const Key keys[] = {
	...
	//{ MODKEY,                       XK_Left,   viewtoleft,     {0} },//--shifttag
	//{ MODKEY,                       XK_Right,  viewtoright,    {0} },
	{ MODKEY|ShiftMask,             XK_h,	   tagtoleft,      {0} },
	{ MODKEY|ShiftMask,             XK_l,	   tagtoright,     {0} },//--shifttag
	{ MODKEY,                       XK_i,	   viewnext,       {0} }, //--skipvacant
	{ MODKEY,                       XK_u,	   viewprev,       {0} },
	//{ MODKEY|ShiftMask,             XK_Right,  tagtonext,      {0} },
	//{ MODKEY|ShiftMask,             XK_Left,   tagtoprev,      {0} }, //--skipvacant
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
	...
	{ MODKEY|ControlMask,           XK_q,      spawn,          {.v = kill_dwm} },
};
